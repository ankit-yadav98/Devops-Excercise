...
To be able to login as `admin` via ssh, you have to copy your public key (from ~/.ssh) into a file `/home/fesi/.ssh/authorized_keys`.
...
Now you can ssh into the Droplet as user `admin`:
- `ssh admin@<droplet-ip-address>`
